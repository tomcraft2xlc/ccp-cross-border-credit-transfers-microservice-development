...
VALUES
-- pacs 008
(tipologiaPACS008, 'pacs_008_clientela', 'Pacs.008', false, null, false, false),
(tipologiaPACS009COV, 'pacs_009_clientela', 'Pacs.009 COV', false, null, false, false),
(tipologiaPACS008EPACS009COV, 'pacs_008_009_cov', 'Pacs.008 con Pacs.009 COV', false, null, false, false),
(tipologiaPACS009, 'pacs_009_banca', 'Pacs.009', false, null, true, false);
...
(gen_random_uuid(), tipologiaPACS008EPACS009COV, 'pacs.009.001.08', 'com.flowpay.ccp.credit.transfer.cross.border.mappers.Pacs009ISOMapper'),
