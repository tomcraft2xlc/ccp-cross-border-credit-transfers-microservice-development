 ...
 */
@Table("dati_conferma_bonifico_errore_tecnico")
public record DatiConfermaBonificoErroreTecnico(
    ...
    public static final class Entity implements com.flowpay.ccp.persistence.Entity<DatiConfermaBonificoErroreTecnico, Repository> {
        ...
        @Override
        public Class<DatiConfermaBonificoErroreTecnico> entityClass() {
            return DatiConfermaBonificoErroreTecnico.class;
        }

    }

    public static final class Repository extends com.flowpay.ccp.persistence.Repository<DatiConfermaBonificoErroreTecnico> {

        public Repository(SqlClient client,
                java.util.function.Function<io.vertx.mutiny.sqlclient.Row, DatiConfermaBonificoErroreTecnico> decoder) {
            super(client, decoder);
        }

        public Multi<DatiConfermaBonificoErroreTecnico> getAllByDatiConfermaBonifico(UUID idDatiConfermaBonifico) {
            return multi("""
                SELECT * FROM dati_conferma_bonifico_errore_tecnico 
    ...
    public class WithLinkedEntities implements EntityWithLinkedEntities {
        ...
        @Override
        public DatiConfermaBonificoErroreTecnico getEntity() {
            return DatiConfermaBonificoErroreTecnico.this;
        }
