...
public record BonificoInUscita(
        UUID id,
        String tid,
    ...
    public static PaginatedResponse<BonificoInUscita> toPaginatedResponse(Page<BonificoInUscita> page, PaginationRequest request) {
