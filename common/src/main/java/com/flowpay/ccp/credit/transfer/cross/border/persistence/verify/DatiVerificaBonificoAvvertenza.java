 ...
 */
@Table("dati_verifica_bonifico_avvertenze")
public record DatiVerificaBonificoAvvertenza(
    ...
    public static final class Entity implements com.flowpay.ccp.persistence.Entity<DatiVerificaBonificoAvvertenza, Repository> {
        ...
        @Override
        public Class<DatiVerificaBonificoAvvertenza> entityClass() {
            return DatiVerificaBonificoAvvertenza.class;
        }

    }

    public static final class Repository extends com.flowpay.ccp.persistence.Repository<DatiVerificaBonificoAvvertenza> {

        public Repository(SqlClient client,
                java.util.function.Function<io.vertx.mutiny.sqlclient.Row, DatiVerificaBonificoAvvertenza> decoder) {
            super(client, decoder);
        }

        public Multi<DatiVerificaBonificoAvvertenza> getAllByDatiVerificaBonifico(UUID idDatiVerificaBonifico) {
            return multi("""
                SELECT * FROM dati_verifica_bonifico_avvertenze 
    ...
    public class WithLinkedEntities implements EntityWithLinkedEntities {
        ...
        @Override
        public DatiVerificaBonificoAvvertenza getEntity() {
            return DatiVerificaBonificoAvvertenza.this;
        }
