...
import com.flowpay.ccp.credit.transfer.cross.border.mappers.mx.pacs_009.MxPacs00900108Mapper;
...
public class Pacs009ISOMapper implements ISOMapper {
    @Override
    ...
    public MxMapper mxMapper(BonificoExtraSepa.WithLinkedEntities bonifico, MappingContext context) {
        return Mappers.getMapper(MxPacs00900108Mapper.class);
    }
